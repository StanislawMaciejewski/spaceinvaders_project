...
--               c:/Projekt/spaceinvaders_project/SpaceInvaders_microblaze_project/SpaceInvaders_microblaze_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
-- Design      : clk_wiz_0
...
architecture STRUCTURE of clk_wiz_0_clk_wiz_0_clk_wiz is
  ...
  signal clk_out_100MHz_clk_wiz_0_en_clk : STD_LOGIC;
  signal clk_out_65MHz_clk_wiz_0 : STD_LOGIC;
  signal clk_out_65MHz_clk_wiz_0_en_clk : STD_LOGIC;
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out_100MHz_clk_wiz_0_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out_65MHz_clk_wiz_0_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_100MHz_clk_wiz_0_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out_65MHz_clk_wiz_0_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg2(0)
